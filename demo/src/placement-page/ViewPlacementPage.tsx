...
export function viewPlacementPage(
  dispatch: Dispatcher<PlacementPageMsg>,
  page: PlacementPage
) {
  ...
  return viewportDim
    .map((vd) => {
      ...
      const placedBox: Box = placeFct(
        vd,
        box(pos(mousePos.x, mousePos.y), refDim),
        elemDim
      );
      const viewDim = (d: Dim) => (
        <span>
      ...
      return (
        <div className="demo">
          <div className="dimensions">
            <ul>
              <li>
                mode: {page.mode} (toggle with <code>M</code>)
              </li>
              ...
              <li>
                placed: {viewPos(placedBox.p)}, {viewDim(placedBox.d)}
              </li>
            </ul>
          </div>
          <div
